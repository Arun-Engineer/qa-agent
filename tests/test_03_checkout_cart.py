...
def test_checkout_cart(page: Page):
    jiomart_login(page)
    expect(page).not_to_have_url(re.compile(r'.*login.*'))
    # Add your cart checkout logic here
    # For example, navigate to cart and perform checkout actions
    # Assertions to verify successful checkout can be added here